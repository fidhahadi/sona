    ...
    return (
        <div className="lg:py-24 lg:px-48 ">
            ...
            <div className="container">
                ...
                <br />
                <div className="text">
                    <p className="text-l font-medium text-center text-gray-700">At Sona Crockery, we specialize in providing quality kitchenware and electronic appliances. Our store has a wide range of items, from school items to kitchenware to electronic appliances. We also have a retail counter where customers can purchase directly from us.

                    </p>
                    <br />
                    <p className="text-l font-medium text-center text-gray-700"> Our mission is to make sure our customers are always satisfied with the products and services that we provide. We strive to bring our customers the best items at the best prices, with a focus on quality and customer service. Visit us today to see what we have to offer</p>
                </div>
            </div>
            <br /><br />
