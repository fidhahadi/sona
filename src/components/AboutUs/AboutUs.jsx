    ...
    <div className="lg:py-24 lg:px-48 ">
        ...
        <br />
            <div className="flex w-1/2">
                <div>
                  <p className="text-l font-medium text-center text-gray-700">Sona Crockery is a family-owned business that has been in operation for over 25 years. We are passionate about making beautiful and unique pieces of crockery that will last for generations. </p>
                  <br />
